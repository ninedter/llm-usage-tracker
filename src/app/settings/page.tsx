  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pb-8">
      ...
      <div className="titlebar-drag mb-6 flex items-center justify-between pt-2">
        ...
        <Link
          href="/"
          className="titlebar-no-drag inline-flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
        >
          <svg
            className="h-4 w-4"
            fill="none"
